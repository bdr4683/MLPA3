...
def train_test_clf( classifier, data_name, data_tuple, pause=False ):
    ...
    timer_clf = DebugTimer( str(classifier) + " on " + data_name )
...
def grid_search( classifier, data_name, parameter_values, data_tuple,
    ...
    timer_grid = DebugTimer( str(classifier) + " on " + data_name )
    ...
    print('')
    ncheck("Selected parameters ('model')", grid_search.best_params_)
